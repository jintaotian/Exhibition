            ...
            myChart.on(ecConfig.EVENT.CLICK, (param) => {
            	...
            	if(param.type == 'click'){
            		if(param.name == '安徽'){
            			...
            			window.location.href="area/lieb-sfx.htm";
            		}
            ...
            option = {
				    series : [
				    	{	
				            ...
				            geoCoord: {
				                '扬州':[119.421407,32.401323],
				                '淮安':[119.040826,33.651861],
				                '徐州':[117.200938,34.27317],
				                '常州':[119.983724,31.805752],
				                '镇江':[119.454801,32.187922],
				                '苏州':[120.570137,31.33319],
				            },
				            markPoint : {
				                symbol:'emptyCircle',
				                clickable:false,

    ...
    require(
        ...
        function (ec) {
            ...
            //var sqmap = ec.init(document.getElementById('sqmap'))
          	var huanx = ec.init(document.getElementById('huanx'));
            var ecConfig = require('echarts/config');
            var flag = true;
            myChart.on(ecConfig.EVENT.CLICK, (param) =>{ 
            	if(param.type == 'click'){
            		if(flag){
            			option.series[0].mapType = param.data.name
            			...
            			flag = true;
            			$('.maskWrap').show();
			    		$('.map-country').css('margin-left','-50%');
			    ...
			    series : [
			        ...
			        },
			        {
			            ...
			            data : [
			                ...
			                {name:'玉米', value:70,itemStyle : labelTop}
			            ]
			        },
			        {
			            type : 'pie',
			    ...
			    series : [
			        {
			            ...
			            data : [
			                ...
			                {name:'人数占比', value:1, itemStyle : labelTop}
			            ]
			        },
			    ]
			}
